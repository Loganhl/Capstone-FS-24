...
function Maketables(){
    ...
    let q7 = 'CREATE TABLE IF NOT EXISTS percentages (wpm_perc FLOAT, click_dwell_perc FLOAT, dwell_time_perc FLOAT, keys_per_sec_perc FLOAT, mouse_speed_perc FLOAT, time_between_keystrokes_perc FLOAT, FOREIGN KEY (USER_ID) REFERENCEs USER_ENTITY(ID));'
    connection.query(q7);
}
